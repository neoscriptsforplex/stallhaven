...
- **Upgrade / Furnace:** free. Place with the floor snap grid, then Confirm. Click it to smelt ores into bars. Right-click to move or rotate. A new shop does not start with one; an old save that already placed a furnace keeps it.
- **Upgrade / Cooking Range:** free. Place with the floor snap grid, then Confirm. Click it to bake food. Right-click to move or rotate.
...
- **Upgrade / Shelf:** same 500g then ×3 curve. The starting three wall shelves are included; extras place on the wall grid. Right-click to move, rotate, or Display item….
